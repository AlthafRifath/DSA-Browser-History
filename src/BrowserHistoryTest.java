public class BrowserHistoryTest {
    public static void main(String[] args) {
        ...
        browserHistory.insertBrowserHistory("Delete Browser History Test", "004E", "04.08.2023", "https://www.deletebrowserhistory.com/", false);

        // Deleting a browser history
        browserHistory.deleteBrowserHistory("004E");
